...
if __name__ == '__main__':
    #print(remove_stopwords("The Godfather"))
    print(get_movies("Oliver Hirschbiegel"))
    #print(get_movies("2001"))
    result = get_movies("Oliver Hirschbiegel")
    print(result)

    # Extraire les genres réels des films
    true_labels = ["Adventure", "Comedy"]  # Remplacez par les genres réels de vos films
